import {Bars3BottomLeftIcon, DocumentTextIcon, HomeIcon, MagnifyingGlassIcon, PlusIcon} from '@heroicons/react/24/solid'
        ...
        <div className=" mx-0 lg:mx-1 ">
            <div className=" lg:rounded-lg navbar bg-neutral">
                ...
                <div className="navbar-center">
                    <a className="btn btn-ghost normal-case text-xl" href={'/'}>onLIST</a>
                </div>
